...
password,
/**
_ A URL to redirect to after the user verifies their email (optional)
_/
callbackURL: "/dashboard",
/**
_ remember the user session after the browser is closed.
_ @default true
\*/
rememberMe: false
}, {
...
/**
_ The social provider ID
_ @example "github", "google", "apple"
\*/
provider: "github",
/**
_ A URL to redirect after the user authenticates with the provider
_ @default "/"
_/
callbackURL: "/dashboard",
/\*\*
_ A URL to redirect if an error occurs during the sign in process
_/
errorCallbackURL: "/error",
/\*\*
_ A URL to redirect if the user is newly registered
_/
newUserCallbackURL: "/welcome",
/\*\*
_ disable the automatic redirect to the provider.
_ @default false
_/
...
/\*\*
_ If the device is trusted, the user won't
_ need to pass 2FA again on the same device
\*/
trustDevice: true
})
}
